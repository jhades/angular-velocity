...
gulp.task('es6', ['angular2'], function () {
...
gulp.task('build-ngv2', ['build-css', 'es6'], function() {
    return gulp.src('./showcase/index.html')
        .pipe(cachebust.references())
        .pipe(gulp.dest('dist'));
});

gulp.task('watch/ngv2', function() {
    gulp.watch([
        './ngv/styles/**/*.*css',
        './ngv2/**/*.html',
        './ngv2/**/*.js',
        './showcase/**/*.js',
        './showcase/**/*.html'], ['build-ngv2']);
});

gulp.task('serve/ngv2', function() {
    gulp.src('.')
        .pipe(webserver({
            livereload: true,
            port:9001,
...
gulp.task('ngv2', ['watch/ngv2', 'serve/ngv2']);
