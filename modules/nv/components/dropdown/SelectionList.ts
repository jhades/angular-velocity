...
import {CursorScrollable, CursorScrollableElement} from 'nv/decorators';
...
@View({
    template: `
                <div nv-cursor-scrollable [last-nav-action]="lastNavAction"
    ...
    directives: [NgFor, CursorScrollable, CursorScrollableElement]
})
